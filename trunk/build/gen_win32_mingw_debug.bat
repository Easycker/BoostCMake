...
:: 工程目录
md win32_mingw_debug 2>nul
cd win32_mingw_debug
...
%CMAKE% -DCMAKE_CXX_COMPILER_FORCED=1 -DCMAKE_C_COMPILER_FORCED=1 -DCMAKE_C_COMPILER_WORKS=1 -DCMAKE_CXX_COMPILER_WORKS=1 -DCMAKE_BUILD_TYPE=Debug -G "MinGW Makefiles" ../../
