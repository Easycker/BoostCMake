...
:: 工程目录
md win32_nmake_release 2>nul
cd win32_nmake_release
...
%CMAKE% -DCMAKE_CXX_COMPILER_FORCED=1 -DCMAKE_C_COMPILER_FORCED=1 -DCMAKE_C_COMPILER_WORKS=1 -DCMAKE_CXX_COMPILER_WORKS=1 -DCMAKE_BUILD_TYPE=Release -G "NMake Makefiles" ../../
